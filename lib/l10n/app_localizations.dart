...
abstract class AppLocalizations {
  ...
  /// No description provided for @homePageEmptyMessage.
  ///
  /// In en, this message translates to:
  /// **'No todos yet'**
  String get homePageEmptyMessage;

  /// No description provided for @hiveTodosLog.
  ///
  /// In en, this message translates to:
  /// **'🔍 Hive Todos ({count, plural, =0{no items} =1{{count} item} other{{count} items}}):'**
  String hiveTodosLog(int count);

  /// No description provided for @printTodosTooltip.
  ///
  /// In en, this message translates to:
  /// **'Print todos to console'**
  String get printTodosTooltip;
  ...
  /// No description provided for @addTodoTitle.
  ///
  /// In en, this message translates to:
  /// **'Add Todo'**
...
class _AppLocalizationsDelegate
  ...
  bool isSupported(Locale locale) =>
      <String>['br', 'en', 'es'].contains(locale.languageCode);
